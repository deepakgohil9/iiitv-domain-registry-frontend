...
>
	<div class="px-6">
		<a
			...
			aria-label="IIITV Registry"
			href="/app">IIITV Registry</a
		>
	</div>
	...
	>
		<ul class="space-y-1.5">
			<li>
				<a
					class="flex items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 text-sm text-slate-700 rounded-lg dark:bg-gray-900 dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
					,
					href="/app"
				>
					<svg
...
<!-- End Sidebar -->
<div
	class="flex flex-col h-screen justify-between w-full pt-10 px-4 sm:px-6 md:px-8 lg:ps-72 dark:bg-slate-900 bg-gray-100"
>
	<slot />
</div>
